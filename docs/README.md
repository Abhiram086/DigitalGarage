...
### Frontend (Mobile)
 ...
 3D Rendering: modelviewerplus

 Typography: googlefonts (Monoton, Outfit, Roboto Mono)
...
GET /api/vehicles/models/?make=MAKEID>
...
GET /api/vehicles/generations/?model=MODELID>
...
GET /api/vehicles/engines/?generation=GENERATIONID>
...
GET /api/vehicles/specifications/?generation=GENERATIONID>&engine=ENGINEID>
...
The seed command uses Django ORM and getorcreate() to avoid unnecessarily duplicating existing makes, models, engines, generations, and specifications.
